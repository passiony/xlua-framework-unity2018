...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTestBaseTestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(XLuaTest.BaseTest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.BaseTest constructor!");
        ...
        static int _m_Foo(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.BaseTest gen_to_be_invoked = (XLuaTest.BaseTest)translator.FastGetCSObj(L, 1);
