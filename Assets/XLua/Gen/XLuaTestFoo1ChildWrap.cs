...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTestFoo1ChildWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(XLuaTest.Foo1Child);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XLuaTest.Foo1Child gen_ret = new XLuaTest.Foo1Child();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.Foo1Child constructor!");
        ...
        static int _m_Extension1(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.Foo1Child gen_to_be_invoked = (XLuaTest.Foo1Child)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Extension2(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.Foo1Child.Extension2!");
